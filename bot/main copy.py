...
TOPIC_IDS = os.getenv('TOPIC_IDS').split(',')  # Memisahkan string menjadi list
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard = [[InlineKeyboardButton("Lihat Postingan", url=post_url)]]
    reply_markup = InlineKeyboardMarkup(keyboard)
...
async def main() -> None:
    ...
    application.add_handler(CommandHandler('start', send_topic_buttons))
